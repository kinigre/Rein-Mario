...
class LearingMario(QWidget):
    ...
    def paintEvent(self, event):
        ...
        screen_tiles = np.concatenate((full_screen_tiles, full_screen_tiles),
                                      axis=1)[:, screen_tile_offset:screen_tile_offset + 16]
        ...
        if player_float_state == 0x03 or player_state in (0x06, 0x0B) or \
                player_vertical_screen_position >= 2 or current_chromosome.stop_frames > 180:
